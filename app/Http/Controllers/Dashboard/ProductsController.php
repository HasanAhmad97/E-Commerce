...
class ProductsController extends Controller
{
    ...
    public function store(GeneralProductRequest $request)
    {
        ...
        //save product tags
        DB::commit();
        return view('dashboard.products.prices.create',compact('product'))->with(['success' => 'تم ألاضافة بنجاح']);
...
//
        ...
        return view('dashboard.products.images.create',compact('product_id'))->with(['success' => 'تم التحديث بنجاح']);
    }
    ...
    public function saveProductImagesDB(ProductImagesRequest $request){
        ...
        try {
            ...
            return view('dashboard.products.stock.create',compact('productId'))->with(['success' => 'تم التحديث بنجاح']);
            return redirect()->route('admin.products')->with(['success' => 'تم التحديث بنجاح']);

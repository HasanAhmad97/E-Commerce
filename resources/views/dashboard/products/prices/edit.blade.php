                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form"
                                              action="{{route('admin.products.price.edit')}}"
                                              method="POST"
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <select default="{{$product->special_price_type}}" name="special_price_type" class="select2 form-control" multiple>
                                                                <optgroup label="{{$product->special_price_type}}">
